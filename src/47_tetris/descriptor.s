...
.cs_task_t:	dq	0x00CF_FA00_0000_FFFF
.ds_task_t:	dq	0x00CF_F200_0000_FFFF
.end:
...
CS_TASK_T:	equ	(.cs_task_t - LDT) | 4 | 3
DS_TASK_T:	equ	(.ds_task_t - LDT) | 4 | 3
...
.cs_bit16:	dq	0x000F_9A00_0000_FFFF
.ds_bit16:	dq	0x000F_9200_0000_FFFF
...
.tss_t:		dq	0x0000_8900_0000_0067
